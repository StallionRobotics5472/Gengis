...
public class AutoDriveEncoderReset extends CommandBase {
    ...
    public void initialize() {
        ...
        Robot.drive.rightMaster.getEncoder().setPosition(0);
        Robot.drive.leftMaster.getEncoder().setPosition(0);
        
    }

    double setPoint = 0;

    public AutoDriveEncoderReset(double Encoder) {
        setPoint = Encoder;
